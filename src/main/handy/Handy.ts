...
import type {DeviceFeature} from "../Intiface";
import type {IntifaceFeatureInformation, IntifaceInt32, IntifaceUInt32, Device, IntifaceDeviceFeatureSelection} from "../IntifaceProtocol";
...
function buildHandyIntifaceSelection(): IntifaceDeviceFeatureSelection {
    const range: [IntifaceInt32, IntifaceInt32] = [0 as IntifaceInt32, 100 as IntifaceInt32];
    const feature: IntifaceFeatureInformation = {
        FeatureIndex: 0 as IntifaceUInt32,
        FeatureDescription: 'Stroker',
        Output: {Position: {Value: range}},
    };
    const device: Device = {
        DeviceIndex: 0 as IntifaceUInt32,
